...
class mathquiz: 
    ...
    def Ans_Check(self):
        try:
            ...
            if self.counter == 1:  #change this to 9 for answer
    ...
    #frame 3        
    def results(self):
        self.results_title = Label(self.frame3, text = "Results!", font = ("Helvetica", "16", "bold"), fg = "white", bg = "#5B9BD5")
        self.results_title(row = 1, column = 0, columnspan = 4)
