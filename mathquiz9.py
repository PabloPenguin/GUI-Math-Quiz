...
class mathquiz: 
    ...
    def results(self):
        ...
        self.scrolled_display.insert(END, "Name: " + self.name_entry.get() + " Age: " + self.age_entry.get() + " Difficulty: " + str(challenge) + " Score: " + str(self.score))
