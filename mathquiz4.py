...
class mathquiz: 
    ...
    def questions(self):
        ...
        self.check_ans = Button(self.frame2, width = 20, text = "check wuz gucci", command = self.Ans_Check )
        self.check_ans.grid(row = 2, column = 3, sticky = W)
        
        self.next_btn = Button(self.frame2, text = "Next", width = 5,  relief = RIDGE, command = self.Next)
