...
class mathquiz: 
    ...
    def results(self):
        ...
        self.finalname = Label(self.frame3, text = "Name")
        self.finalname.grid(row=1, column=0)
        self.finalage = Label(self.frame3, text = "Age")
        self.finalage.grid(row=1, column=1)
        self.finaldifficulty = Label(self.frame3, text = "Difficulty")
        self.finaldifficulty.grid(row=1, column=2)
        self.finalscore = Label(self.frame3, text = "Score")
        self.finalscore.grid(row=1, column=3)
